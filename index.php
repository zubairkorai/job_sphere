        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
            ...
            <div class="col-xl-10 ftco-animate mb-5 pb-5" data-scrollax=" properties: { translateY: '70%' }">
                <p class="mb-4 mt-5 pt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We have
                    <span class="number" data-number="850000">0</span> great job offers you deserve!
                </p>
                <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"> <br>Search <br>
                    Your Job. </h1>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-field">
                                                        ...
                                                        <input type="text" name="keyword" id="keyword"
                                                            class="form-control" placeholder="eg. Backend Developer">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md">
                ...
                <div class="col-md-12 ftco-animate">
                    ...
                    <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                        ...
                        <div class="mb-4 mb-md-0 mr-5">
                            <div class="job-post-item-header d-flex align-items-center">
                                ...
                                <div class="badge-wrap">
                                    <span
                                        class="bg-primary text-white badge py-2 px-3"><?php echo $row['city']; ?></span>
                                </div>
                            </div>
                            <div class="job-post-item-body d-block d-md-flex">
                                <div class="mr-3"><span class="icon-layers"></span> <a
                                        href="#"><?php echo $row['company']; ?></a></div>
                        ...
                        <div class="ml-auto d-flex">
                            <a href="blog-single.php?id=<?php echo $row['jobs_id']; ?>"
                    ...
                    <div class="item">
                        <div class="testimony-wrap py-4 pb-5">
                            ...
                            <div class="text">
                                ...
                                <p class="name">Mr. Aqeel</p>
                                <span class="position">UI Desginer</span>
                            </div>
                        </div>
                    </div>
                    <div class="item">
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>
                        We provide a wide range of tools and resources to assist you in discovering the ideal
                        opportunity to demonstrate your skills and expertise.</p>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                    ...
                    </script> All rights reserved | <i class="icon-heart text-danger" aria-hidden="true"></i> <a
