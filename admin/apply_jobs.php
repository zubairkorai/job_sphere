    ...
    <table id="example" class="display" style="width:100%">
        ...
        <tbody>
            <?php
                include ('connection/db.php');
                $a = 1;
                $sql = mysqli_query($conn, "SELECT * from job_apply LEFT JOIN all_jobs ON job_apply.id_job = all_jobs.jobs_id WHERE customer_email='{$_SESSION['email']}'");
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="btn-group">
                            <a href="view_applied_jobs.php?id=<?php echo $row['id']; ?>"
